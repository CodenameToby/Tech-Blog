# Tech-Blog
Tech blog site that demonstrates Model-View-Controller framework
...
# Credits
Thank you to GitHub user KrispyWing. Their completed assignment gave guidance on how to code the routes themselves.
